    ...
    public function readiness(PortfolioProfile $profile, array $input): array
    {
        ...
        return [
            'status' => $limitations === [] ? 'ready' : (array_intersect($limitations, [
                ...
                'historical_reservation_state_unavailable',
                'historical_recall_state_unavailable',
                'historical_bridge_loan_state_unavailable',
                'historical_strategy_binding_unavailable',
                'historical_strategy_metadata_unavailable',
