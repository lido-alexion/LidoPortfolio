...
class SettingsController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'minimum_actionable_buy_amount' => ['nullable', 'numeric', 'min:0'],
            'opportunity_cost_rate' => ['nullable', 'numeric', 'min:0', 'max:1'],
            'portfolio_max_position_pct' => ['nullable', 'numeric', 'min:0', 'max:100'],
            'max_lending_pct_of_unused' => ['nullable', 'numeric', 'min:0', 'max:100'],
            'max_lending_absolute' => ['nullable', 'numeric', 'min:0'],
