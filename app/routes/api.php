...
Route::middleware(['auth:sanctum', 'active.portfolio'])->group(function () {
    ...
    Route::post('/replays/compare', [PortfolioReplayController::class, 'compare']);
...
Route::prefix('v1')->middleware(['auth:sanctum', 'active.portfolio'])->group(function () {
    ...
    Route::post('/backtests/{id}/strategy-draft', [BacktestController::class, 'createDraft'])->whereNumber('id');
