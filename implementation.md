...
**V2 F127 (2026-08-09):** Formal specification pack — [`docs/v2/F127-PORTFOLIO-ALERTS-SPEC.md`](docs/v2/F127-PORTFOLIO-ALERTS-SPEC.md), [`F127-BOUNDARY.md`](docs/v2/F127-BOUNDARY.md), [`F127-POLICY-DECISIONS.md`](docs/v2/F127-POLICY-DECISIONS.md), [`F127-IMPLEMENTATION-GAP-MATRIX.md`](docs/v2/F127-IMPLEMENTATION-GAP-MATRIX.md). Indexed in `DOCS.md` §3.E. Status: **`READY_FOR_IMPLEMENTATION`** (policies closed; primary hardening delta = PD-F127-07 expire→evaluate daily order; preserve repeated Telegram digests and implicit re-arm).
