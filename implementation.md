...
6. UI shows latest close for stock and benchmark, **historical start-close tables** (stock + index) for 1M/3M/6M/1Y, **four RS cards** (1M / 3M / 6M / 1Y) color-coded green/red, bar chart, and 1-year normalized % gain line chart.
