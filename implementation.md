...
Living technical reference for StoX / Lido Portfolio. **Update this file whenever code changes.**

Current product behaviour is documented in [`docs/current/README.md`](docs/current/README.md). Older versioned specs referenced below are archived historical context unless they have been re-stated in `docs/current`.
...
Specs under `docs/archive/specs/` define a seven-engine decision platform. Implementation evolves the **existing** Lido Portfolio app (no greenfield rewrite). Progress: `docs/archive/specs/IMPLEMENTATION_PROGRESS.md`. Demo acceptance: `docs/archive/specs/MVP_DEMO_CHECKLIST.md`.
...
**Independent audit (2026-07-25):** Full freeze audit vs `/specs` lives in [`docs/archive/specs/architecture/audit/`](docs/archive/specs/architecture/audit/). Verdict: clarified MVP **YES** (~90%); release posture **Ready for Internal Testing Only** — see `docs/archive/specs/architecture/audit/MVP_VERDICT.md`.

**Governance (2026-07-25):** Bridge between architectural intent and V1.0 code — [`docs/archive/specs/architecture/governance/`](docs/archive/specs/architecture/governance/). Precedence: [`DOCUMENT_PRECEDENCE.md`](docs/archive/specs/architecture/governance/DOCUMENT_PRECEDENCE.md). Baseline: [`VERSION_1_BASELINE.md`](docs/archive/specs/architecture/governance/VERSION_1_BASELINE.md). Do not rewrite original `/specs` architecture or engine docs to match implementation; record decisions as SD-xxx instead.

**V1 scope freeze (2026-08-09, SD-035):** Product-owner decision promotes four previously ambiguous capabilities to formal V1 — **F004** password reset, **F020** corporate actions (core; not F043 repair), **F058** screener backtesting, **F093** strategy backtesting (current shipped simulation). Eleven capabilities deferred to V2/future: F003, F005, F014, F019, F042, F043, F060, F127, F137, F143, F144. Authoritative scope: [`MVP_SCOPE.md`](docs/archive/specs/architecture/governance/MVP_SCOPE.md). Decision record: [`docs/archive/audits/2026-08-09-feature-coverage/V1-SCOPE-DECISION.md`](docs/archive/audits/2026-08-09-feature-coverage/V1-SCOPE-DECISION.md).

**Documentation map:** Repository-wide reading order and file tree — [`DOCS.md`](DOCS.md). Specs subtree — [`docs/archive/specs/README.md`](docs/archive/specs/README.md). Architecture hub (domain folders) — [`docs/archive/specs/architecture/README.md`](docs/archive/specs/architecture/README.md). For full ingest: requirements/architecture → governance → audit → this file. New Markdown docs must be indexed in `DOCS.md` (rule: `.cursor/rules/Keep-DOCS-md-ingestion-tree-updated.mdc`).
...
Tracked in [`docs/archive/specs/LidoPortfolio-V4-Wishlist.md`](docs/archive/specs/LidoPortfolio-V4-Wishlist.md) (strict rewrite 2026-08-26; Product Owner V4/V5 split 2026-08-26):
...
**Status:** **COMPLETE**. Frozen product rules in `docs/archive/specs/LidoPortfolio-V4-Wishlist.md` V4-FEAT-002. Builds on FEAT-001 / FEAT-024 / SPEC-001 / SPEC-003. SPEC-004 and SPEC-005 are implemented separately. Does not implement any other V4 FEAT.
...
**Status:** **COMPLETE**. Frozen product rules in `docs/archive/specs/LidoPortfolio-V4-Wishlist.md` V4-FEAT-010. Makes FEAT-001 Automatic mode operational end-to-end in production. Does not change the decision algorithm, execution modes, TOTP, `executed` = fill, GTT, or reservation/capital rules.
...
Authoritative: [`docs/archive/specs/LidoPortfolio-V3-Specification.md`](docs/archive/specs/LidoPortfolio-V3-Specification.md) §13–§15, §21, §34.3, §35.7; OD-13, OD-14, OD-22.
...
- [`docs/archive/specs/architecture/domains/REST-API-Specification.md`](docs/archive/specs/architecture/domains/REST-API-Specification.md)
- [`docs/archive/specs/architecture/audit/API_INVENTORY.md`](docs/archive/specs/architecture/audit/API_INVENTORY.md)
...
Authoritative: V3 **v0.28**; [`docs/archive/specs/architecture/V3-WS4-Recall-Bridge-Implementation-Delta.md`](docs/archive/specs/architecture/V3-WS4-Recall-Bridge-Implementation-Delta.md).
...
Authoritative: [`docs/archive/specs/LidoPortfolio-V3-Specification.md`](docs/archive/specs/LidoPortfolio-V3-Specification.md) **v0.28**; [`docs/archive/specs/architecture/V3-WS4-Recall-Bridge-Implementation-Delta.md`](docs/archive/specs/architecture/V3-WS4-Recall-Bridge-Implementation-Delta.md).
...
- Authoritative product SoT: [`docs/archive/specs/LidoPortfolio-V3-Specification.md`](docs/archive/specs/LidoPortfolio-V3-Specification.md) **v0.28**.
- Implementation delta: [`docs/archive/specs/architecture/V3-WS4-Recall-Bridge-Implementation-Delta.md`](docs/archive/specs/architecture/V3-WS4-Recall-Bridge-Implementation-Delta.md).
...
Authoritative spec: [`docs/archive/specs/LidoPortfolio-V3-Specification.md`](docs/archive/specs/LidoPortfolio-V3-Specification.md) **v0.28** (was written against v0.27; repayment behaviour preserved — any amount ≤ outstanding, not ₹5,000 multiples).
...
**Recall**, recall eligibility (OD-07), FIFO loan selection (OD-09), weakest-position sells (OD-16), Recall Bridge Loan, capital-resolution orchestrator, notifications, UI, HTTP repay endpoint, UNFUNDED loan sizing — see [`docs/archive/specs/architecture/V3-WS4-Recall-Bridge-Implementation-Delta.md`](docs/archive/specs/architecture/V3-WS4-Recall-Bridge-Implementation-Delta.md).
...
Authoritative spec: [`docs/archive/specs/LidoPortfolio-V3-Specification.md`](docs/archive/specs/LidoPortfolio-V3-Specification.md) **v0.27**. Spec file was **not** edited.
...
Authoritative spec: [`docs/archive/specs/LidoPortfolio-V3-Specification.md`](docs/archive/specs/LidoPortfolio-V3-Specification.md) v0.26 (OD-01–OD-24 and DEP-* frozen). This workstream does **not** change that file.
...
Authoritative spec: [`docs/archive/specs/LidoPortfolio-V3-Specification.md`](docs/archive/specs/LidoPortfolio-V3-Specification.md) v0.26. Spec file was **not** edited. Workstream 1 identity/multi-enable is unchanged.
...
Authoritative spec: [`docs/archive/specs/LidoPortfolio-V3-Specification.md`](docs/archive/specs/LidoPortfolio-V3-Specification.md) v0.27. Spec file was **not** edited this pass.
...
**Architecture specs reorganization (2026-08-06):** Documentation-only moves under `docs/archive/specs/architecture/` (`platform/`, `ui/`, `indicators/`, `portfolio/`, `data/`, `domains/`, `live-trading/`, `integrations/`, `governance/`, `audit/`). Filenames unchanged. `engines/` renamed to `domains/`; `System-Domain-Model.md` lives under `platform/`. Summary: [`docs/archive/specs/architecture/MIGRATION-SUMMARY.md`](docs/archive/specs/architecture/MIGRATION-SUMMARY.md).

**Architecture Repository V1.0 (Frozen):** Structure, governance, naming, and authoring rules are stable — start at [`docs/archive/specs/architecture/platform/README.md`](docs/archive/specs/architecture/platform/README.md) (Platform Architecture) and [`docs/archive/specs/architecture/governance/ARCHITECTURE_REPOSITORY_BASELINE_V1.md`](docs/archive/specs/architecture/governance/ARCHITECTURE_REPOSITORY_BASELINE_V1.md). Extend the repo; do not reorganize it.
...
**Navigation architecture (2026-07-30):** Production sidebar refactored for maintainability — `navigation/` registry (`ROUTES`, icon registry, permissions context, `registerModule` for future plugins/marketplace/custom dashboards), reusable `NavMenuItem` / `NavGroup` / `NavBadge` / `NavTooltip`, config-driven catalogs. Spec: [`docs/archive/specs/architecture/ui/15-Sidebar-Navigation-Architecture.md`](docs/archive/specs/architecture/ui/15-Sidebar-Navigation-Architecture.md). Legacy AppTabs / AppBottomNav removed.
...
**Trading OS pages & flow (2026-07-29):** Product-facing map of Screener / Strategy / Discovery / Recommendations / Pending Execution / Review (what each page shows + recommendation path). Spec: [`docs/archive/specs/architecture/ui/07-Trading-OS-Pages-and-Flow.md`](docs/archive/specs/architecture/ui/07-Trading-OS-Pages-and-Flow.md). In-app Documentation topic `trading-os-flow` (also linked from overview and related TOS pages). Indexed in `DOCS.md` §2.6a.

**Indicator architecture analysis (2026-07-30):** As-built report of dual catalogues (`ScreenerCatalog` + `SupportedIndicators`), `TechnicalIndicatorService`, Evaluation composites, consumers, storage, and extensibility — [`docs/archive/specs/architecture/indicators/08-Indicator-Architecture-Analysis.md`](docs/archive/specs/architecture/indicators/08-Indicator-Architecture-Analysis.md).

**Indicator Registry design (2026-07-30, SD-033):** Target evolution — unified metadata/discovery Registry; preserve TI + Evaluation + Strategy scoring; types Primary/Composite/Metric; Admin Indicator Registry UI; planned Liquidity/Tradability indicators (metadata only). Specs: [`docs/archive/specs/architecture/indicators/09-Indicator-Registry.md`](docs/archive/specs/architecture/indicators/09-Indicator-Registry.md), [`docs/archive/specs/architecture/domains/Indicator-Registry-Specification.md`](docs/archive/specs/architecture/domains/Indicator-Registry-Specification.md). Strategy-param→Evaluation wiring tracked separately (TD-19 / PB-054). Implementation plan: [`docs/archive/specs/architecture/indicators/10-Indicator-Registry-Implementation-Plan.md`](docs/archive/specs/architecture/indicators/10-Indicator-Registry-Implementation-Plan.md). Indexed in `DOCS.md` §2.6b–d / §2.14l.

**Trading Artifact Framework (SD-034):** Shared envelope for **Indicator**, **Screener**, and **Strategy** artifacts. **Shipped:** envelope/validation, package I/O, Indicator/Screener/Strategy registries, Create/Enable/Archive, AI authoring/runtime docs, V3 multi-strategy surfaces (see Registry infrastructure notes below). **Not shipped / V5 V4-FEAT-008 (2026-08-28):** immutable published versions vs Save-in-place as a first-class model, sharing/distribution, extra AI draft-from-schema catalogue UX, dependency dashboards, rollback, bundle UI, fork workflows. Do not treat shipped registries as unimplemented. Specs: [`docs/archive/specs/architecture/indicators/11-Trading-Artifact-Framework.md`](docs/archive/specs/architecture/indicators/11-Trading-Artifact-Framework.md), [`docs/archive/specs/architecture/domains/Trading-Artifact-Framework-Specification.md`](docs/archive/specs/architecture/domains/Trading-Artifact-Framework-Specification.md). Backlog remainder: PB-058+ / V4-FEAT-008. Indexed in `DOCS.md` §2.6e / §2.14n.
...
- **API (admin):** `GET /api/v1/indicators`, `/meta`, `/{id}` — see `docs/archive/specs/architecture/domains/Indicator-Registry-API.md`.
...
- **Docs:** `docs/archive/specs/architecture/indicators/13-Indicator-Lifecycle.md`, `14-Indicator-Registry-Diagrams.md`; contextual help topic `indicator-registry`.
...
**F042 V2 hardening (2026-08-09):** Formal V2 implementation pass per `docs/archive/v2/F042-DATA-QUALITY-SPEC.md` and product-owner policy decisions (`docs/archive/v2/F042-POLICY-DECISIONS.md`). Changes:
...
- **Compliance:** `docs/archive/v2/F042-FINAL-COMPLIANCE-AUDIT.md` — remaining intentional non-blockers: no unique pending-dedupe index; optional 409 fresh-issue body.

**F043 specification / reconciliation (2026-08-09):** Planning docs under `docs/archive/v2/` — `F043-CORPORATE-ACTION-PRICE-REPAIR-SPEC.md`, `F043-IMPLEMENTATION-GAP-MATRIX.md`, `F043-F042-BOUNDARY.md`. Indexed in `DOCS.md` §3.C.
...
**Regression snapshot:** F043+delegation+adjustment/repair+F042 **67/67**; recommendation/pipeline/market gates **23/23**; full suite @512M **612** tests (**603** passed, **5** failed, **4** errors — unrelated/pre-existing; suite not fully green). Tracking: `docs/archive/v2/V2-ROADMAP.md`, `DOCS.md` §3.B–3.C.
...
**V2 F127 (2026-08-09):** Formal pack + hardening — [F127-PORTFOLIO-ALERTS-SPEC.md](docs/archive/v2/F127-PORTFOLIO-ALERTS-SPEC.md), [F127-BOUNDARY.md](docs/archive/v2/F127-BOUNDARY.md), [F127-POLICY-DECISIONS.md](docs/archive/v2/F127-POLICY-DECISIONS.md), [F127-IMPLEMENTATION-GAP-MATRIX.md](docs/archive/v2/F127-IMPLEMENTATION-GAP-MATRIX.md). Indexed in `DOCS.md` §3.E. Verdict: **`F127_COMPLETE_WITH_NON_BLOCKERS`**. Final compliance audit: compliant with non-blockers. Tracking cleanup: `V2-ROADMAP.md` and PD-F127-07 CURRENT wording aligned to expire→evaluate (no behaviour change).
...
**V2 F019 (2026-08-09):** Bulk CSV Import hardening complete. Pack: [F019-BULK-CSV-IMPORT-SPEC.md](docs/archive/v2/F019-BULK-CSV-IMPORT-SPEC.md), [F019-BOUNDARY.md](docs/archive/v2/F019-BOUNDARY.md), [F019-POLICY-DECISIONS.md](docs/archive/v2/F019-POLICY-DECISIONS.md), [F019-IMPLEMENTATION-GAP-MATRIX.md](docs/archive/v2/F019-IMPLEMENTATION-GAP-MATRIX.md). Indexed in `DOCS.md` §3.F. Verdict: **`F019_COMPLETE_WITH_NON_BLOCKERS`**.
...
Follow-up full-suite hardening normalizes every provider OHLCV session key before `updateOrCreate`. Equivalent `Y-m-d`, ISO-8601, and timestamp inputs now resolve to the same stored trading date instead of racing into the unique `(stock_id, price_date)` constraint. This closes the live-provider corporate-action test failure without changing provider precedence or price values.

## V4-FEAT-031 — external secrets and single-folder deploy (2026-09-04)

**Status:** **IMPLEMENTED; PRODUCTION CUTOVER PENDING.** Frozen behavior and acceptance criteria: [`docs/archive/specs/V5-FEAT-031-Production-Secrets-Single-Folder-Deploy.md`](docs/archive/specs/V5-FEAT-031-Production-Secrets-Single-Folder-Deploy.md). Operator runbook: [`deploy/SINGLE-FOLDER-DEPLOY.md`](deploy/SINGLE-FOLDER-DEPLOY.md).
...
**V2 Account & Access (2026-08-09):** Spec pack for **F003** (User Invite) and **F005** (Session Management) — [F003-F005-BOUNDARY.md](docs/archive/v2/F003-F005-BOUNDARY.md), [F003-USER-INVITE-SPEC.md](docs/archive/v2/F003-USER-INVITE-SPEC.md), [F005-SESSION-MANAGEMENT-SPEC.md](docs/archive/v2/F005-SESSION-MANAGEMENT-SPEC.md), [F003-F005-POLICY-DECISIONS.md](docs/archive/v2/F003-F005-POLICY-DECISIONS.md), [F003-F005-IMPLEMENTATION-GAP-MATRIX.md](docs/archive/v2/F003-F005-IMPLEMENTATION-GAP-MATRIX.md). Indexed in `DOCS.md` §3.D.
