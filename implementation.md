...
- **V5-deferred FEAT (18, still OPEN):** B4 banner, notification channels, indicator-registry cutover, **TAF remaining phases (FEAT-008)**, admin force-logout, cash-as-of/export/compare, tax/attribution/benchmarks, mobile/AI/ML/markets/replay, CI/secrets deploy, Discovery/Evaluation UX polish, TS/grid migration, optional token API. Roadmap only — remainder not implemented; shipped TAF registries/I/O stay shipped.
