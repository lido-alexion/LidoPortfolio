...
**F014 (next):** Spec pack + product-owner decisions closed 2026-08-09 — `docs/v2/F014-HISTORICAL-HOLDINGS-SPEC.md`, `F014-BOUNDARY.md`, `F014-POLICY-DECISIONS.md`, `F014-IMPLEMENTATION-GAP-MATRIX.md`. DECIDED MVP: dedicated as-of API + page (qty/cost/valuation/unrealized; warnings; fee-exclusive cost; ledger-truth; on-demand). Substrate: `PortfolioHistoricalHoldingsService` (F015 consumer). Product surface **not yet implemented**. Status: **`READY_FOR_IMPLEMENTATION`**.
