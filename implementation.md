...
- `StockAutocomplete.jsx` — debounced search; shows `exchange_label` (`NSE+` for dual-listed); optional `clearOnBlur` clears typed text when the field loses focus without a selection (used by Watchlist quick-add)
