...
| V4-FEAT-038 | Exchange holidays in Calendar with automatic holiday-list sync | V5-deferred item, subsequently **completed 2026-09-04**; see canonical V5 register. | P2 | COMPLETE |
