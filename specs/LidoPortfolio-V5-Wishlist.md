...
| V4-FEAT-039 | Holiday-aware scheduled order execution | **Implementation in progress (2026-09-05):** [`V5-FEAT-039-Holiday-Aware-Scheduled-Execution.md`](V5-FEAT-039-Holiday-Aware-Scheduled-Execution.md). Holiday-aware target-seeking lifetime, Investor execution batches, Automatic plus explicitly authorized Semi-Automatic account coordination, same-symbol internal transfers/final valuation, shared-funds resizing, bounded margin retries, mode/supersession handling, UX progress, and lifecycle notifications are implemented. Final current-state revalidation and full-suite closure remain. | P2 | IN PROGRESS |
