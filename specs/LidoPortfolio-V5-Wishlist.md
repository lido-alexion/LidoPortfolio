...
| V4-FEAT-042 | Separate role-based Admin Portal and investor application | **Implementation in progress:** [`V5-FEAT-042-Role-Separated-Admin-Investor-Applications.md`](V5-FEAT-042-Role-Separated-Admin-Investor-Applications.md). Server-side Admin rejection from Investor portfolio APIs/default-portfolio creation and distinct role-selected frontend route/navigation shells are implemented. Remaining gate: non-destructive existing Admin-owned investment-data detection/reporting and broader direct-API boundary audit. | P1 | IN PROGRESS |
