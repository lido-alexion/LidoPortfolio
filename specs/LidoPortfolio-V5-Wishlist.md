...
| V4-FEAT-039 | Holiday-aware scheduled order execution | **Implementation in progress (2026-09-04):** [`V5-FEAT-039-Holiday-Aware-Scheduled-Execution.md`](V5-FEAT-039-Holiday-Aware-Scheduled-Execution.md). The first foundation slice adds immutable two-session lifetime derivation, target/progress decomposition fields, Investor execution batches, and idempotent provisional/final internal-transfer persistence. Coordinator behavior remains to be wired. | P2 | IN PROGRESS |
