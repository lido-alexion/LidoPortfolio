...
| V4-FEAT-004 | Notification channel abstraction + email/webhook | **Implementation in progress:** [`V5-FEAT-004-Notification-Service.md`](V5-FEAT-004-Notification-Service.md). Canonical lifecycle storage, account-scoped APIs, both-role in-app UX and encrypted account-level Telegram/Email/Webhook settings now implement strict audience isolation, attention/condition separation, filtered history, counts, read actions, active deduplication, escalation, recurrence and verification-before-enable gates. Remaining work includes verification/delivery adapters, durable delivery/retry/reminders, health conditions, settings UI and migration of existing producers. FEAT-004 absorbs FEAT-003. | P2 | IN PROGRESS |
