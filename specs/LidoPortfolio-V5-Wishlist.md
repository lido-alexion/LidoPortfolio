...
| V4-FEAT-004 | Notification channel abstraction + email/webhook | **Implementation in progress:** [`V5-FEAT-004-Notification-Service.md`](V5-FEAT-004-Notification-Service.md). Canonical lifecycle storage, account-scoped APIs, both-role Notification Center, global unread bell and persistent aggregate Critical banner now implement strict audience isolation, attention/condition separation, filtered history, timelines, counts, read actions, active deduplication, escalation and recurrence. Remaining work includes channel settings/adapters, durable delivery/retry/reminders, health conditions and migration of existing producers. FEAT-004 absorbs FEAT-003. | P2 | IN PROGRESS |
