...
| V4-FEAT-042 | Separate role-based Admin Portal and investor application | **Implementation in progress:** [`V5-FEAT-042-Role-Separated-Admin-Investor-Applications.md`](V5-FEAT-042-Role-Separated-Admin-Investor-Applications.md). Server-side Admin rejection from Investor portfolio APIs/default-portfolio creation, distinct role-selected frontend route/navigation shells, and a read-only deployment-blocking Admin-owned investment-data audit are implemented. Remaining gate: broader direct-API boundary audit and remediation of any gaps it discovers. | P1 | IN PROGRESS |
