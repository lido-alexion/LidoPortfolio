...
| Artifact | Path |
|----------|------|
| Audit pack | `specs/architecture/audit/` |
| Verdict | `specs/architecture/audit/MVP_VERDICT.md` |
| Traceability | `specs/architecture/audit/SPECIFICATION_TRACEABILITY.md` |
| Architecture compliance | `specs/architecture/audit/ARCHITECTURE_COMPLIANCE.md` |
| API / UI / DB inventories | `specs/architecture/audit/API_INVENTORY.md`, `UI_INVENTORY.md`, `DATABASE_MAPPING.md` |
| Limitations / debt | `specs/architecture/audit/KNOWN_LIMITATIONS.md`, `TECHNICAL_DEBT.md` |
| Manual acceptance script | `specs/architecture/audit/MVP_TEST_SCRIPT.md` |
...
See `specs/architecture/audit/KNOWN_LIMITATIONS.md`. Material baseline limitations:
...
See `specs/architecture/audit/TECHNICAL_DEBT.md` and Critical/High items in [`./PRODUCT_BACKLOG.md`](./PRODUCT_BACKLOG.md).
...
Promotion requires soak using `specs/architecture/audit/MVP_TEST_SCRIPT.md` and progress on Critical backlog items.
