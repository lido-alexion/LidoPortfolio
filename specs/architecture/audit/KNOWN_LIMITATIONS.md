...
10d. **Trading Artifact Framework final authoring/rollout remains open in V5 (V4-FEAT-008)** (updated 2026-09-09) — Immutable lifecycle/distribution, exact Portfolio runtime resolution, legacy identity backfill/projection, mapped compatibility guards, artifact-version/binding-revision evidence through Screener runs and Recommendation/order/fill execution, and immutable resumable backtest snapshots are implemented. New legacy create/import paths can still originate unmapped rows; representative-data rollout and the final full-suite audit also remain to be closed. See [`../../V5-FEAT-008-IMPLEMENTATION-STATUS.md`](../../V5-FEAT-008-IMPLEMENTATION-STATUS.md).
