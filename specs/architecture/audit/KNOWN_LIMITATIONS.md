...
10d. **Trading Artifact Framework runtime cutover remains open in V5 (V4-FEAT-008)** (updated 2026-09-09) — The V5 immutable lifecycle, exact dependency graph, Library permissions/provenance, versioned Portfolio bindings, explicit upgrades, sharing/adoption/Fork, validated package I/O, transactional Bundles, usability monitoring/notifications, APIs and consolidated UI are implemented. The live Strategy/Screener runtime still consumes legacy save-in-place records and Recommendation/order/execution rows do not yet retain the originating V5 artifact version/binding revision. FEAT-008 cannot be marked complete until that non-parallel cutover and evidence propagation are implemented and validated. See [`../../V5-FEAT-008-IMPLEMENTATION-STATUS.md`](../../V5-FEAT-008-IMPLEMENTATION-STATUS.md).
