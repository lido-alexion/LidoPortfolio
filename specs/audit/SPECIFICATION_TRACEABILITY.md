...
1. `specs/engines/Implementation-Roadmap.md` §9 Success Criteria  
...
## 2. `architecture/02-Guiding-Principles.md`
...
## 3. `architecture/03-Core-Concepts.md`
...
## 4. `architecture/04-System-Architecture.md`
...
## 5. `architecture/05-Daily-Decision-Pipeline.md`
...
## 6. `architecture/06-Engine-Overview.md`
