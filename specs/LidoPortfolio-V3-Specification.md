...
| **Implementation Status**  | **V3 STRICTLY COMPLETE** (2026-08-26 strict register-to-implementation pass). Every normative V3 requirement is implemented; known V3 bugs, V3 technical debt, and V3 UX gaps from the V4 register are closed. V4 holds only genuine new functionality and genuine unspecified product/spec decisions. |
