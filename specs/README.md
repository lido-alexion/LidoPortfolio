...
**V4:** [LidoPortfolio-V4-Wishlist.md](LidoPortfolio-V4-Wishlist.md) is closed history. **V5:** [LidoPortfolio-V5-Wishlist.md](LidoPortfolio-V5-Wishlist.md) is active; [V5-FEAT-031-Production-Secrets-Single-Folder-Deploy.md](V5-FEAT-031-Production-Secrets-Single-Folder-Deploy.md) records implemented deploy hardening pending production cutover, [V5-FEAT-033-Discovery-Inline-Default-Screener.md](V5-FEAT-033-Discovery-Inline-Default-Screener.md) records the completed Discovery UX, [V5-FEAT-034-Richer-Evaluation-History-UX.md](V5-FEAT-034-Richer-Evaluation-History-UX.md) records the completed Evaluation history UX, [V5-FEAT-035-Frontend-Stack-Migration.md](V5-FEAT-035-Frontend-Stack-Migration.md) tracks the incremental frontend migration, [V5-FEAT-037-Dashboard-Kite-Readiness.md](V5-FEAT-037-Dashboard-Kite-Readiness.md) records Dashboard broker readiness, [V5-FEAT-038-Exchange-Holiday-Calendar.md](V5-FEAT-038-Exchange-Holiday-Calendar.md) records the canonical NSE holiday calendar, [V5-FEAT-039-Holiday-Aware-Scheduled-Execution.md](V5-FEAT-039-Holiday-Aware-Scheduled-Execution.md) is frozen, and [V5-FEAT-040-Kite-Portfolio-Reconciliation.md](V5-FEAT-040-Kite-Portfolio-Reconciliation.md) is frozen for later implementation.
