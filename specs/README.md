...
**V4:** [LidoPortfolio-V4-Wishlist.md](LidoPortfolio-V4-Wishlist.md) is closed history. **V5:** [LidoPortfolio-V5-Wishlist.md](LidoPortfolio-V5-Wishlist.md) is the active closure register. FEAT-015 performance/tax, FEAT-040 Kite reconciliation and FEAT-041 Linked Markdown Wiki are complete; FEAT-020 is substantially implemented but awaits the frozen configurable-parameter declaration decision; FEAT-008, FEAT-031 and FEAT-042 retain explicit production-evidence gates. Later V6–V9 registers are preserved roadmap material and do not authorize implementation during V5 closure.
