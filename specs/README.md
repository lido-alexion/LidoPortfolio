...
│   ├── StoX-Trading-Artifacts-AI-Guide.md (AI pack: Contract-first + registries + cookbook + runtime appendix; /docs/stox-trading-artifacts-ai-guide.md)
...
19d6. [engines/StoX-Trading-Artifacts-AI-Guide.md](engines/StoX-Trading-Artifacts-AI-Guide.md) (AI authoring pack incl. runtime semantics; deploy `/docs/stox-trading-artifacts-ai-guide.md`)
