...
| V7-REQ-002 | Fundamental data integration | PARTIALLY_IMPLEMENTED | Fundamental admin/page/provider/services/migrations | `V7/FundamentalDataIntegrationTest`, `V7/MlScoringLifecycleTest` | Deployed schema/scheduler exist, but production has 0 canonical facts; Yahoo provider runs repeatedly fail HTTP 401 and leave queued/retry work | Yes | `V7-REQ-002-FUNDAMENTALS-RUNTIME-VERIFICATION.md`; deep historical bootstrap is explicitly deferred to V8/V4-FEAT-054, while provider recovery and representative current-data ingestion remain required |
