...
| AUD-008 | V5-REQ-008, V6-REQ-002 | Backtest/paper semantics | Backtest, replay and paper execution are distinct, safely isolated and reachable | Batch 1 now proves historical Replay branch reconstruction, as-of holdings/cash/ownership, binding/version pins, capital-state components, source isolation, processed checkpoints, and precise fail-closed blockers; PIT resync and browser/deployment checks remain | PARTIALLY_IMPLEMENTED | Medium | Medium | V5 FEAT-020 and V6 E2 specs | backtest pages/services/routes; `HistoricalReplayStateBuilder` | Replay foundation plus historical branch assurance tests | UI semantics, post-resync PIT, deployed workers and browser/runtime behavior | Run each workflow with representative portfolio and controlled resync | AUD-013 | SIM-001 implemented; SIM-002/SIM-003/SIM-004 remain bounded verification work |
