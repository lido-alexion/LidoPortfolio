...
V4 Product Owner rules **V4-SPEC-001 through V4-SPEC-006** are recorded in [`../../LidoPortfolio-V4-Wishlist.md`](../../LidoPortfolio-V4-Wishlist.md) §4 (`DECIDED` 2026-08-26; implementation status is on each SPEC row there — do not copy those rules here as new SD rows). This register remains the V1.0 intent-vs-implementation SD log.
