...
| Artifacts | Trading Artifact Framework **remainder** (SD-034 design accepted; envelope/registries/package I/O later shipped; remaining phases are **V5 V4-FEAT-008**, not V1) |
