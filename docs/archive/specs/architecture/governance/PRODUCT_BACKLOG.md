...
| PB-058 | Architecture | Trading Artifact Framework Phase 1–2 | Shared envelope schemas; Screener artifact metadata + export/import (**keep `definition_json`**). **Spec:** [../indicators/11-Trading-Artifact-Framework.md](../indicators/11-Trading-Artifact-Framework.md) | **Infrastructure shipped** (envelope + Screener Registry I/O). Remaining SD-034 → **V5 V4-FEAT-008** | Screener module, SD-033 | 1.2 |
| PB-059 | Architecture | Trading Artifact Framework Phase 3–4 | Strategy artifact library + portfolio binding; umbrella ArtifactRegistry + dependency resolver | **Partial:** Strategy Registry + `ArtifactRegistry` shipped. Remaining dual library/binding UX / immutable versions / dashboards → **V5 V4-FEAT-008** | Strategy Configuration, PB-058 | 1.2 |
| PB-060 | Architecture / AI | Trading Artifact Framework Phase 5 | AI catalogue cards + draft-from-schema validate-before-activate | **Partial:** AI authoring/runtime docs shipped. Extra catalogue UX → **V5 V4-FEAT-008** | ArtifactRegistry, UI | 1.3 |
