...
**Date:** 2026-08-09 (final V1 baseline — frozen scope SD-035)  
**Baseline:** TOS-V1.0-2026-07-25 + scope freeze 2026-08-09 (`MVP_SCOPE.md`, `SPECIFICATION_DECISIONS.md` SD-035)  
**Method:** Spec review + repository inspection + PHPUnit run (no code changes)  
**Previous baselines:** [2026-08-08](../2026-08-08-feature-coverage/) · [2026-08-09 pre-freeze](../2026-08-09-feature-coverage/)
...
## Summary counts (2026-08-09 final — frozen V1 scope SD-035)
...
V1_OUT_OF_SCOPE rows (40) are excluded from this denominator. **V1_SCOPE_AMBIGUOUS = 0** — scope freeze SD-035 resolved all prior ambiguous rows.

**Weighted effective coverage (optional):** (119 + 0.5×0) ÷ 119 = **100.0%** — partial rows counted at 50%; supplementary only.

### Secondary attributes (not added to row totals)

| Secondary Attribute | Count |
|---------------------|------:|
| NOT_SPECIFIED (documentation gap) | 11 |
...
| F003 | Auth | User invite flow | V1_OUT_OF_SCOPE | IMPLEMENTED | NOT_SPECIFIED | YES | YES | YES | YES | N/A | YES | P3 | — | SD-035 deferred | `UserInviteService.php`, `/invite/:token` | V2/future |
| F004 | Auth | Password reset | V1_REQUIRED | IMPLEMENTED | — | YES | YES | YES | YES | N/A | YES | P1 | — | MVP_SCOPE SD-035 | `PasswordResetLinkService`, `PasswordResetLinkTest` (6 tests) | Formal V1 per SD-035 |
| F005 | Auth | Session management (list/revoke) | V1_OUT_OF_SCOPE | PARTIALLY_IMPLEMENTED | NOT_SPECIFIED | YES | YES | YES | PARTIAL | N/A | YES | P3 | — | SD-035 deferred | `SessionManagementService.php` | V2/future; partial UI |
...
| F014 | Holdings | Historical holdings reconstruction | V1_OUT_OF_SCOPE | IMPLEMENTED | NOT_SPECIFIED | YES | YES | YES | PARTIAL | N/A | YES | P2 | — | SD-035 deferred | `PortfolioHistoricalHoldingsService`, rebuild-history | V2/future |
| F015 | Holdings | Portfolio snapshots | V1_REQUIRED | IMPLEMENTED | — | YES | YES | YES | YES | N/A | YES | P2 | — | Portfolio-Analytics-Spec | `GET /api/portfolio/snapshots`, `PortfolioSnapshotsPage.jsx`, `PortfolioSnapshotGrowthChart.jsx`, `PortfolioSnapshotApiTest` | Dedicated `/portfolio/snapshots` page with chart, table, ranges, profile scoping |
...
| F019 | Transactions | Bulk CSV import | V1_OUT_OF_SCOPE | IMPLEMENTED | NOT_SPECIFIED | YES | YES | YES | YES | N/A | PARTIAL | P3 | — | SD-035 deferred | `BulkTransactionImport.jsx` | V2/future |
| F020 | Transactions | Corporate actions | V1_REQUIRED | IMPLEMENTED | — | YES | YES | YES | YES | YES | YES | P1 | — | MVP_SCOPE SD-035 | `CorporateActionService`, `CorporateActionPage.jsx`, sync commands; unit tests (3 errors in SQLite fixture — non-blocker) | Core split/bonus; not F043 repair |
...
| F042 | Data Quality | Data quality detection/resolution | V1_OUT_OF_SCOPE | IMPLEMENTED | NOT_SPECIFIED | YES | YES | YES | YES | YES | PARTIAL | P2 | — | SD-035 deferred | `DataQualityGuardService`, admin UI | V2/future |
| F043 | Data Quality | Corporate action price repair | V1_OUT_OF_SCOPE | IMPLEMENTED | NOT_SPECIFIED | YES | YES | YES | PARTIAL | YES | YES | P2 | — | SD-035 deferred | Repair services, deploy scripts | V2/future; not F020 core |
...
| F058 | Screeners | Screener backtesting (hit matrix) | V1_REQUIRED | IMPLEMENTED | — | YES | YES | YES | YES | N/A | YES | P1 | — | MVP_SCOPE SD-035 | `ScreenerBacktestService`, editor UI, `ScreenerTest`, `ScreenerBacktestCalendarTest` | See BACKTEST-COVERAGE.md |
...
| F060 | Screeners | Shared screener import | V1_OUT_OF_SCOPE | IMPLEMENTED | NOT_SPECIFIED | YES | YES | YES | YES | N/A | PARTIAL | P3 | — | SD-035 deferred | `ScreenerSharedTab.jsx` | V2/future |
...
| F093 | Strategy | Strategy backtesting | V1_REQUIRED | IMPLEMENTED | — | YES | YES | YES | YES | N/A | PARTIAL | P1 | TEST GAP | MVP_SCOPE SD-035 | `BacktestSimulationEngine`, `/backtests`, unit tests; no API feature tests | See BACKTEST-COVERAGE.md |
...
| F098 | Market Analysis | Market gates in live recommendations | V1_REQUIRED | IMPLEMENTED | — | YES | YES | YES | PARTIAL | N/A | YES | P2 | — | Strategy-Spec | `MarketGateEvaluator`, `RecommendationGenerationPipeline`, `MarketGateEvaluatorTest`, `MarketGateRecommendationTest` | OPEN/INCREASE demotion; allocation multiplier; evidence/reasoning on recommendations |
...
| F127 | Notifications | Portfolio alerts (non-TOS) | V1_OUT_OF_SCOPE | IMPLEMENTED | NOT_SPECIFIED | YES | YES | YES | YES | YES | YES | P2 | — | SD-035 deferred | `AlertService`, `AlertPolicyService` | V2/future; parallel to TOS Telegram |
...
| F137 | Analytics | Recommendation preview | V1_OUT_OF_SCOPE | IMPLEMENTED | NOT_SPECIFIED | N/A | YES | YES | PARTIAL | N/A | NO | P3 | — | SD-035 deferred | `RecommendationPreviewService` | V2/future |
...
| F143 | Frontend | In-app contextual help docs | V1_OUT_OF_SCOPE | IMPLEMENTED | NOT_SPECIFIED | N/A | YES | YES | YES | N/A | NO | P3 | — | SD-035 deferred | `appDocumentation.js`, `/documentation` | V2/future |
| F144 | Frontend | Knowledge Board | V1_OUT_OF_SCOPE | IMPLEMENTED | NOT_SPECIFIED | YES | YES | YES | YES | N/A | YES | P3 | — | SD-035 deferred | `KnowledgeBoardPage.jsx` | V2/future |
...
| F148 | Pipeline | Optional scheduled pipeline | V1_REQUIRED | IMPLEMENTED | — | N/A | YES | N/A | N/A | YES | YES | P1 | — | MVP_SCOPE | `DecisionPipelineScheduleService`, `routes/console.php`, `TRADING_OS_PIPELINE_SCHEDULE`, trading-day guard, overlap lock | Off by default (config); scheduler + tests wired |
| F149 | Pipeline | Run after daily sync hook | V1_REQUIRED | IMPLEMENTED | — | N/A | YES | N/A | N/A | YES | YES | P2 | — | Implementation-Roadmap | `DailyMarketDataJob::runDecisionPipelineAfterSync`, `TRADING_OS_PIPELINE_AFTER_SYNC`, per-profile retry + shared automatic lock | Triggers only after successful sync; skipped on partial/failed sync |
...
| F155 | Tests | Broad feature test coverage | V1_REQUIRED | IMPLEMENTED | — | N/A | YES | YES | NO | N/A | PARTIAL | P2 | — | MVP_VERDICT | 549 PHPUnit tests / 124 files (2026-08-09 run: 542 pass, 3 fail, 4 error); major V1 workflows covered | No React test suite; strategy backtest API feature tests absent; 7 legacy failures (non-TOS) |
...
### Spec → Implementation (V1 required — post-implementation)

| Spec requirement | Status | ID(s) |
|------------------|--------|-------|
| Hard data publish gates | V1_OUT_OF_SCOPE / PB-001 deferred | F040 |
| Evaluations dedicated page | IMPLEMENTED + DEVIATION:DEV-001 | F076 |
| Pipeline scheduling ops | **IMPLEMENTED** | F148, F149 |
| Market gates in live recommendations | **IMPLEMENTED** | F098 |
| Portfolio snapshots UI | **IMPLEMENTED** | F015 |
| Broad feature test coverage | **IMPLEMENTED** (residual test debt non-blocking) | F155 |
| Strategy backtest API feature tests | Test debt only; F093 V1_REQUIRED | F155 note |

### Implementation → Spec (unspecified features)

See `IMPLEMENTED-BUT-UNSPECIFIED.md` for V2/future documentation gaps (11 NOT_SPECIFIED on deferred rows). Promoted V1 rows F004, F020, F058, F093 are now in `MVP_SCOPE.md` SD-035.

---

*Generated 2026-08-09 final baseline (frozen V1 scope SD-035). Historical: [2026-08-09 pre-freeze](../2026-08-09-feature-coverage/), [2026-08-08](../2026-08-08-feature-coverage/).*
