...
**Scope:** Screener Backtesting (F058), Strategy Backtesting (F093) — both **V1_REQUIRED** per SD-035  
**Previous audit:** [2026-08-09 pre-freeze](../2026-08-09-feature-coverage/BACKTEST-COVERAGE.md)
...
|------|--------|-------------------|------------|
| **Screener backtest** | IMPLEMENTED | **V1_REQUIRED (F058)** | Hit matrix only |
| **Strategy backtest** | IMPLEMENTED | **V1_REQUIRED (F093)** | Full paper simulation |
...
### V1 Scope Status (frozen SD-035)

| Feature | Primary Status | V1 Scope | Spec Coverage |
|---------|----------------|----------|---------------|
| **Screener backtesting** (F058) | IMPLEMENTED | **V1_REQUIRED** | MVP_SCOPE § Screener Authoring |
| **Strategy backtesting** (F093) | IMPLEMENTED | **V1_REQUIRED** | MVP_SCOPE § Strategy Research |
...
| **Portfolio snapshots UI (F015)** | **YES** | `PortfolioSnapshotsPage.jsx`, `GET /api/portfolio/snapshots`, `PortfolioSnapshotGrowthChart.jsx` |
...
| Portfolio equity curve backtest UI | NOT IMPLEMENTED | F015 snapshots UI covers live portfolio history, not strategy replay |
...
│ Test coverage       │ Feature      │ Unit only       │ Snapshot API tests (F015) │
└─────────────────────┴──────────────┴─────────────────┴──────────────────┘
```
