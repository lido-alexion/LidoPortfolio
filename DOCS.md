...
| **V4 deferred work** | [specs/LidoPortfolio-V4-Wishlist.md](specs/LidoPortfolio-V4-Wishlist.md) | **Wishlist / deferred register** after V3 freeze — **21** active V4 features (**17** COMPLETE including FEAT-001, FEAT-002, FEAT-005, FEAT-006, FEAT-009, FEAT-010, FEAT-014, FEAT-021–029, FEAT-032; **4** OPEN: 011–013, 015) + frozen SPEC-001–007 (product rules; FEAT-001 implements SPEC-007; FEAT-002 GTT Target/Stop-Loss; FEAT-010 unattended production pipeline; FEAT-009 Review reports list/detail; FEAT-014 Backtest Duplicate; SPEC-001 merge, SPEC-002 rights-are-not-a-CA, SPEC-003 CA restatement, SPEC-004 LOAN/RECALL/BRIDGE, and SPEC-005 explicit SELL attribution implemented 2026-08-28) + **15** V5-deferred FEAT IDs (including **V4-FEAT-008** TAF remainder; shipped TAF registries/I/O stay shipped) |
...
| 2.6e | [specs/architecture/indicators/11-Trading-Artifact-Framework.md](specs/architecture/indicators/11-Trading-Artifact-Framework.md) | **Target** Trading Artifact Framework (SD-034) — **infrastructure shipped**; remainder is **V5 V4-FEAT-008** |
...
| 2.14n | [specs/architecture/domains/Trading-Artifact-Framework-Specification.md](specs/architecture/domains/Trading-Artifact-Framework-Specification.md) | SD-034 Trading Artifact Framework (**registry infrastructure landed**; remainder **V5 V4-FEAT-008**) |
...
*Authoritative V3 product + architecture specification (**v0.28**). Implementation status (2026-08-26): **V3 STRICTLY COMPLETE**, including post-deploy product-surface closure (Discovery removed from the Market sidebar; strategy Create / Enable / Archive for multiple concurrent strategies). Living detail in [`implementation.md`](implementation.md). Genuine new post-V3 work is tracked in [`specs/LidoPortfolio-V4-Wishlist.md`](specs/LidoPortfolio-V4-Wishlist.md) (active V4 **21** = **17** COMPLETE / **4** OPEN; **15** V5-deferred FEAT IDs including **V4-FEAT-008** TAF remainder; V4-SPEC-001–007 are frozen PO decisions; SPEC-007 via FEAT-001; SPEC-001 merge, SPEC-002 rights-are-not-a-CA, SPEC-003 CA restatement, SPEC-004 LOAN/RECALL/BRIDGE, and SPEC-005 explicit SELL attribution implemented 2026-08-28; SPEC-006 unimplemented; FEAT-010 unattended production pipeline COMPLETE; FEAT-009 Review reports list/detail COMPLETE; FEAT-014 Backtest Duplicate COMPLETE). Supersedes V1 one-active-strategy (SD-029) and unfunded→WATCH for V3 work. Frozen OD/DEP decisions are in the document §33.*
...
| 3.78 | [specs/LidoPortfolio-V4-Wishlist.md](specs/LidoPortfolio-V4-Wishlist.md) | **V4 Wishlist / Deferred Work Register** — **21** active V4 features (**17** COMPLETE including FEAT-001, FEAT-002, FEAT-009, FEAT-010, FEAT-014, and FEAT-032; **4** OPEN), SPEC-001–007 **frozen** (FEAT-001 implements SPEC-007; SPEC-001 merge, SPEC-002 rights-are-not-a-CA, SPEC-003 restatement, SPEC-004 LOAN/RECALL/BRIDGE, and SPEC-005 explicit SELL attribution implemented 2026-08-28), **15** V5-deferred FEAT IDs (including **V4-FEAT-008** TAF remainder; shipped TAF infrastructure stays shipped) |
